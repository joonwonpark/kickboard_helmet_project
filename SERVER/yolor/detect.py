...
def detect(opt, model, detect_label, save_img=False):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for c in det[:, -1].unique():
                    detect_label.append(names[int(c)])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/root/kickboard_helmet_project/SERVER/yolor/best.pt', help='model.pt path(s)')
