...
public abstract class CameraActivity extends AppCompatActivity
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    if (hasPermission() && checkLocationServicesStatus()) {
  ...
  void checkRunTimePermission() {
    ...
    if (hasFineLocationPermission == PackageManager.PERMISSION_GRANTED &&
      ...
      if (ActivityCompat.shouldShowRequestPermissionRationale(CameraActivity.this, REQUIRED_PERMISSIONS[0])) {
  ...
  private String chooseCamera() {
    ...
    try {
      for (final String cameraId : manager.getCameraIdList()) {
        ...
        // 전면카메로 쓰려면 front 를 back으로 설정해두고 legacy쪽도 front로 설정
  ...
  protected int getScreenOrientation() {
    System.out.println("getRotation"+getWindowManager().getDefaultDisplay().getRotation());
